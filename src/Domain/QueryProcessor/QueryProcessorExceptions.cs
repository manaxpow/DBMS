...
{
    public LexerException(string message = "Lexer encountered an error.")
        : base(message)
    {
    }
}
...
{
    public SQLParserException(string message = "Parser encountered a syntax error.")
        : base(message)
    {
    }
}
...
{
    public SemanticException(string message = "Semantic analysis failed.")
        : base(message)
    {
    }
}
...
{
    public QueryOptimizerException(string message = "Optimizer failed to generate a plan.")
        : base(message)
    {
    }
}
...
{
    public QueryExecutorException(string message = "Query execution failed.")
        : base(message)
    {
    }
}
